...
export default function Nav({show}) {
  ...
  return (
    <aside className= " p-4 pr-0 bg-white h-screen">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/courses'} className={pathname.includes('/courses') ? activeLink : inactiveLink}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/courses') ? activeIcon : inactiveIcon}>
